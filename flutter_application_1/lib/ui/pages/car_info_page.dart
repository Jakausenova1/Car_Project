               ...
               AppSliderWidget(list: widget.model.sliders),
                ...
                Row(
                  ...
                  children: [
                    ...
                    CircleAvatar(
        radius: 25,
                      child: Image.asset(AppImages.salesname,fit: BoxFit.cover, width: 50,height: 50,),
                    ),
                    const SizedBox(
                      width: 10,
                    ),
                    ...
                    IconButton(
                        onPressed: () {},
                        icon:Image.asset(AppImages.message, width: 30,)),
                    const SizedBox(
                      width: 10,
                    ),
                    IconButton(
                        onPressed: () {},
                        icon: Image.asset(AppImages.call, width: 30,)),
                    ...
                    children: [
                      IconButton(
                          ...
                          icon: Container(
                            ...
                            child: Text('+',style: AppFonts.w700s20.copyWith(color: AppColors.lightBlue),),
                          )),
                          Text(count.toString(),style: AppFonts.w700s20.copyWith(color: AppColors.black),),
                      IconButton(
                          onPressed: () {
                            if(count>0){
                              setState(() {
                          ...
                          icon: Container(
                            ...
                            child: Text('-',style: AppFonts.w700s20.copyWith(color: AppColors.lightBlue),textAlign: TextAlign.center,),
                          )),
                    ],
                  ),
                ),
